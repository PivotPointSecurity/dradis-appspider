...
Gem::Specification.new do |spec|
  ...
  spec.description = 'This add-on allows you to upload and parse output produced from AppSpider Web Vulnerability Scanner into Dradis.'

  spec.license = 'GPL-2'

  spec.authors = ['Michael Gargiullo']
  spec.email = ['michael.gargiullo@pivotpointsecurity.com']
  spec.homepage = 'http://www.pivotpointsecurity.com'
